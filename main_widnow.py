...
window.setStyleSheet("background-color: qradialgradient(cx: 0.5, cy: 0.5, fx: 0.5, fy: 0.5, radius: 0.5, stop: 0 grey , stop: 1 white);;")
btn_menu.setStyleSheet("background-color: qradialgradient(cx: 0.5, cy: 0.5, fx: 0.5, fy: 0.5, radius: 0.5, stop: 0 purple, stop: 1 grey);color: white;;")
btn_next.setStyleSheet("background-color: qradialgradient(cx: 0.5, cy: 0.5, fx: 0.5, fy: 0.5, radius: 0.5, stop: 0 purple, stop: 1 grey);color: white;;")
btn_rest.setStyleSheet("background-color: qradialgradient(cx: 0.5, cy: 0.5, fx: 0.5, fy: 0.5, radius: 0.5, stop: 0 purple, stop: 1 grey);color: white;;")
